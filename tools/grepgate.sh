...
cd "$ROOT" || exit 2
HARD='RCP_|\bVPR\b|VPR_|VehiclePhysicsReworked|Vehicle_Physics_Reworked|Vehicle Physics Reworked|VehiclePhysicsReworkedMod|Indivual|Step Van:0\.95|Step Van:80|Valuline|1990'"'"'s torque converters|onFirstUpdate'
